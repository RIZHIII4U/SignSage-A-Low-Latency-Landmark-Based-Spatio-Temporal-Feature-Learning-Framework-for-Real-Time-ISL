...
# Fixed Motion Energy Threshold (Paper)
...
class SignSageUnifiedPro:
    ...
    def __init__(self):
        ...
        if (
            not os.path.exists(RF_MODEL_PATH)
            or
            not os.path.exists(LSTM_MODEL_PATH)
        ):
    ...
    def run(self):
        ...
        while cap.isOpened():
            ...
            if current_sign != "None":
                ...
                self.history.append(current_sign)
